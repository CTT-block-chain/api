...
import type { AddAppParams, AppFinancedProposalParams, AppFinancedUserExchangeConfirmParams, AppFinancedUserExchangeParams, AppIncomeRedeemConfirmParams, AppIncomeRedeemParams, AppKeyManageParams, AuthAccountId, AuthParamsCreateModel, ClientParamsCreateChooseDoc, ClientParamsCreateIdentifyDoc, ClientParamsCreateModel, ClientParamsCreateModelDoc, ClientParamsCreatePublishDoc, ClientParamsCreateTryDoc, CommentData, FinanceMemberParams, ModelDisputeType, ModelExpertAddMemberParams, ModelExpertDelMemberParams, ModelIncomeCollectingParam, ModelKeyParams, TechFundWithdrawLevel, TechFundWithdrawType } from '@polkadot/types/interfaces/kp';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    kp: {
      ...
      appFinanceRedeemCompensate: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, proposalId: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      appIncomeRedeemCompensate: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, cycle: BlockNumber | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      appIncomeRedeemConfirm: AugmentedSubmittable<(params: AppIncomeRedeemConfirmParams | { account?: any; appId?: any; payId?: any; cycle?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      appIncomeRedeemRequest: AugmentedSubmittable<(params: AppIncomeRedeemParams | { account?: any; appId?: any; cycle?: any; exchangeAmount?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      createModel: AugmentedSubmittable<(clientParams: ClientParamsCreateModel | { appId?: any; expertId?: any; commodityName?: any; commodityType?: any; contentHash?: any } | string | Uint8Array, authParams: AuthParamsCreateModel | { modelId?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createModelCreateDocument: AugmentedSubmittable<(clientParams: ClientParamsCreateModelDoc | { appId?: any; documentId?: any; modelId?: any; productId?: any; contentHash?: any; producerCount?: any; productCount?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      createProductChooseDocument: AugmentedSubmittable<(clientParams: ClientParamsCreateChooseDoc | { appId?: any; documentId?: any; modelId?: any; productId?: any; contentHash?: any; sellCount?: any; tryCount?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createProductIdentifyDocument: AugmentedSubmittable<(clientParams: ClientParamsCreateIdentifyDoc | { appId?: any; documentId?: any; productId?: any; contentHash?: any; goodsPrice?: any; identRate?: any; identConsistence?: any; cartId?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createProductPublishDocument: AugmentedSubmittable<(clientParams: ClientParamsCreatePublishDoc | { appId?: any; documentId?: any; modelId?: any; productId?: any; contentHash?: any; paraIssueRate?: any; selfIssueRate?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createProductTryDocument: AugmentedSubmittable<(clientParams: ClientParamsCreateTryDoc | { appId?: any; documentId?: any; productId?: any; contentHash?: any; goodsPrice?: any; offsetRate?: any; trueRate?: any; cartId?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Register new app
       **/
      democracyAddApp: AugmentedSubmittable<(params: AddAppParams | { appType?: any; appName?: any; appKey?: any; appAdminKey?: any; returnRate?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      modelOwnerRelease: AugmentedSubmittable<(params: ModelKeyParams | { appId?: any; modelId?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    ...
    members: {
      ...
      addFinanceMember: AugmentedSubmittable<(params: FinanceMemberParams | { deposit?: any; member?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      financeMemberAddDeposit: AugmentedSubmittable<(deposit: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
       ...
       * Removes a member.
       **/
      removeFinanceMember: AugmentedSubmittable<(oldMember: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes a member.
       **/
