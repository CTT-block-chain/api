...
import type { AuthAccountId, KPModelCreateData, KPProductChooseData, KPProductIdentifyData, KPProductPublishData, KPProductTryData, ModelDisputeType, PowerSize } from '@polkadot/types/interfaces/kp';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    kp: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      createComment: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, commentId: Bytes | string | Uint8Array, documentId: Bytes | string | Uint8Array, commentHash: Hash | string | Uint8Array, commentFee: PowerSize | AnyNumber | Uint8Array, commentTrend: u8 | AnyNumber | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createCommodityType: AugmentedSubmittable<(typeId: u32 | AnyNumber | Uint8Array, typeDesc: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createModel: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, modelId: Bytes | string | Uint8Array, expertId: Bytes | string | Uint8Array, commodityName: Bytes | string | Uint8Array, commodityType: u32 | AnyNumber | Uint8Array, contentHash: Hash | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createModelCreateDocument: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, documentId: Bytes | string | Uint8Array, modelId: Bytes | string | Uint8Array, productId: Bytes | string | Uint8Array, contentHash: Hash | string | Uint8Array, documentPowerData: KPModelCreateData | { producerCount?: any; productCount?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createPowerLeaderBoard: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, modelId: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createProductChooseDocument: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, documentId: Bytes | string | Uint8Array, modelId: Bytes | string | Uint8Array, productId: Bytes | string | Uint8Array, contentHash: Hash | string | Uint8Array, documentPowerData: KPProductChooseData | { sellCount?: any; tryCount?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createProductIdentifyDocument: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, documentId: Bytes | string | Uint8Array, modelId: Bytes | string | Uint8Array, productId: Bytes | string | Uint8Array, contentHash: Hash | string | Uint8Array, documentPowerData: KPProductIdentifyData | { goodsPrice?: any; identRate?: any; identConsistence?: any; cartId?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createProductPublishDocument: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, documentId: Bytes | string | Uint8Array, modelId: Bytes | string | Uint8Array, productId: Bytes | string | Uint8Array, contentHash: Hash | string | Uint8Array, documentPowerData: KPProductPublishData | { paraIssueRate?: any; selfIssueRate?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      createProductTryDocument: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, documentId: Bytes | string | Uint8Array, modelId: Bytes | string | Uint8Array, productId: Bytes | string | Uint8Array, contentHash: Hash | string | Uint8Array, documentPowerData: KPProductTryData | { goodsPrice?: any; offsetRate?: any; trueRate?: any; cartId?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      democracyAddApp: AugmentedSubmittable<(appType: Bytes | string | Uint8Array, appName: Bytes | string | Uint8Array, appKey: AccountId | string | Uint8Array, appAdminKey: AccountId | string | Uint8Array, returnRate: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      democracyAppFinanced: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, kptAmount: BalanceOf | AnyNumber | Uint8Array, exchangeRate: BalanceOf | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      disableModel: AugmentedSubmittable<(appId: Bytes | string | Uint8Array, modelId: Bytes | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      ...
      setModelYearIncome: AugmentedSubmittable<(year: u32 | AnyNumber | Uint8Array, appId: u32 | AnyNumber | Uint8Array, modelId: Bytes | string | Uint8Array, income: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    members: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
       ...
       **/
      addCouncilMember: AugmentedSubmittable<(newMember: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      addDeveloperMember: AugmentedSubmittable<(newMember: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      addExpertMember: AugmentedSubmittable<(appId: u32 | AnyNumber | Uint8Array, modelId: Bytes | string | Uint8Array, kptProfitRate: u32 | AnyNumber | Uint8Array, modelCreator: AuthAccountId | string | Uint8Array, modelCreatorSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
       ...
       * Removes a member.
       **/
      removeCouncilMember: AugmentedSubmittable<(oldMember: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes a member.
       **/
      removeDeveloperMember: AugmentedSubmittable<(oldMember: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      removeExpertMember: AugmentedSubmittable<(oldMember: AccountId | string | Uint8Array, appId: u32 | AnyNumber | Uint8Array, modelId: Bytes | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes a member.
       **/
