...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    kp: {
      ...
      disableModel: AugmentedSubmittable<(params: DisableModelParams | { app_id?: any; model_id?: any } | string | Uint8Array, appUserAccount: AuthAccountId | string | Uint8Array, appUserSign: Signature | string | Uint8Array, authServer: AuthAccountId | string | Uint8Array, authSign: Signature | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    ...
    members: {
      ...
      addFinanceMember: AugmentedSubmittable<(newMember: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
