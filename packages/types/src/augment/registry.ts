...
import type { AllowedSlots, BabeAuthorityWeight, BabeBlockWeight, BabeCttWeight, BabeEquivocationProof, BabeWeight, EpochAuthorship, MaybeRandomness, MaybeVrf, NextConfigDescriptor, NextConfigDescriptorV1, Randomness, RawBabePreDigest, RawBabePreDigestCompat, RawBabePreDigestPrimary, RawBabePreDigestPrimaryTo159, RawBabePreDigestSecondaryPlain, RawBabePreDigestSecondaryTo159, RawBabePreDigestSecondaryVRF, RawBabePreDigestTo159, SlotNumber, VrfData, VrfOutput, VrfProof } from '@polkadot/types/interfaces/babe';
...
import type { AccountID32, AccountStatistics, AddAppParams, AppData, AppFinanceDataRPC, AppFinanceExchangeDataParams, AppFinanceExchangeDataRPC, AppFinanceRecordParams, AppFinancedData, AppFinancedProposalParams, AppFinancedUserExchangeConfirmParams, AppFinancedUserExchangeData, AppFinancedUserExchangeParams, AppIncomeCycleRecord, AppIncomeDataRPC, AppIncomeExchangeDataParams, AppIncomeRecordParams, AppIncomeRedeemConfirmParams, AppIncomeRedeemParams, AppKeyManageParams, AuthAccountId, AuthParamsCreateModel, ClientParamsCreateChooseDoc, ClientParamsCreateIdentifyDoc, ClientParamsCreateModel, ClientParamsCreateModelDoc, ClientParamsCreatePublishDoc, ClientParamsCreateTryDoc, CommentData, CommentMaxRecord, CommentTrend, CommentWeightData, CommodityLeaderBoardData, CommoditySlashRecord, CommodityTypeData, DisableModelParams, DocumentPower, DocumentPowerInfo, DocumentSpecificData, DocumentType, FinanceMemberParams, KPCommentAccountRecord, KPCommentDataOf, KPDocumentDataOf, KPModelCreateData, KPModelCreateDataMax, KPModelDataOf, KPProductChooseData, KPProductChooseDataMax, KPProductIdentifyData, KPProductIdentifyRateMax, KPProductPublishData, KPProductPublishRateMax, KPProductTryData, KPProductTryRateMax, LeaderBoardItem, LeaderBoardItemRPC, LeaderBoardResult, LeaderBoardResultRPC, MiscDocumentPowerParams, ModelCycleIncomeReward, ModelDisputeRecord, ModelDisputeType, ModelExpertAddMemberParams, ModelExpertDelMemberParams, ModelIncome, ModelIncomeCollectingParam, ModelIncomeCurrentStageRPC, ModelKeyParams, ModelStatus, PowerSize, QueryCommodityPowerParams, QueryDocumentPowerParams, QueryLeaderBoardParams, QueryModelExpertParams, QueryModelParams, QueryPlatformExpertParams, StableExchangeData, StakeToVoteParams, StakeToVoteResult, TechFundWithdrawData, TechFundWithdrawLevel, TechFundWithdrawType } from '@polkadot/types/interfaces/kp';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    BabeCttWeight: BabeCttWeight;
    'Compact<BabeCttWeight>': Compact<BabeCttWeight>;
    'Option<BabeCttWeight>': Option<BabeCttWeight>;
    'Vec<BabeCttWeight>': Vec<BabeCttWeight>;
    ...
    PowerSize: PowerSize;
    'Compact<PowerSize>': Compact<PowerSize>;
    'Option<PowerSize>': Option<PowerSize>;
    'Vec<PowerSize>': Vec<PowerSize>;
    AccountID32: AccountID32;
    'Option<AccountID32>': Option<AccountID32>;
    'Vec<AccountID32>': Vec<AccountID32>;
    AuthAccountId: AuthAccountId;
    'Option<AuthAccountId>': Option<AuthAccountId>;
    'Vec<AuthAccountId>': Vec<AuthAccountId>;
    KPProductPublishData: KPProductPublishData;
    'Option<KPProductPublishData>': Option<KPProductPublishData>;
    'Vec<KPProductPublishData>': Vec<KPProductPublishData>;
    KPProductIdentifyData: KPProductIdentifyData;
    'Option<KPProductIdentifyData>': Option<KPProductIdentifyData>;
    'Vec<KPProductIdentifyData>': Vec<KPProductIdentifyData>;
    KPProductTryData: KPProductTryData;
    'Option<KPProductTryData>': Option<KPProductTryData>;
    'Vec<KPProductTryData>': Vec<KPProductTryData>;
    KPProductChooseData: KPProductChooseData;
    'Option<KPProductChooseData>': Option<KPProductChooseData>;
    'Vec<KPProductChooseData>': Vec<KPProductChooseData>;
    KPModelCreateData: KPModelCreateData;
    'Option<KPModelCreateData>': Option<KPModelCreateData>;
    'Vec<KPModelCreateData>': Vec<KPModelCreateData>;
    LeaderBoardItem: LeaderBoardItem;
    'Option<LeaderBoardItem>': Option<LeaderBoardItem>;
    'Vec<LeaderBoardItem>': Vec<LeaderBoardItem>;
    LeaderBoardItemRPC: LeaderBoardItemRPC;
    'Option<LeaderBoardItemRPC>': Option<LeaderBoardItemRPC>;
    'Vec<LeaderBoardItemRPC>': Vec<LeaderBoardItemRPC>;
    LeaderBoardResultRPC: LeaderBoardResultRPC;
    'Option<LeaderBoardResultRPC>': Option<LeaderBoardResultRPC>;
    'Vec<LeaderBoardResultRPC>': Vec<LeaderBoardResultRPC>;
    ModelStatus: ModelStatus;
    'Option<ModelStatus>': Option<ModelStatus>;
    'Vec<ModelStatus>': Vec<ModelStatus>;
    DocumentType: DocumentType;
    'Option<DocumentType>': Option<DocumentType>;
    'Vec<DocumentType>': Vec<DocumentType>;
    CommentTrend: CommentTrend;
    'Option<CommentTrend>': Option<CommentTrend>;
    'Vec<CommentTrend>': Vec<CommentTrend>;
    ModelDisputeType: ModelDisputeType;
    'Option<ModelDisputeType>': Option<ModelDisputeType>;
    'Vec<ModelDisputeType>': Vec<ModelDisputeType>;
    TechFundWithdrawType: TechFundWithdrawType;
    'Option<TechFundWithdrawType>': Option<TechFundWithdrawType>;
    'Vec<TechFundWithdrawType>': Vec<TechFundWithdrawType>;
    TechFundWithdrawLevel: TechFundWithdrawLevel;
    'Option<TechFundWithdrawLevel>': Option<TechFundWithdrawLevel>;
    'Vec<TechFundWithdrawLevel>': Vec<TechFundWithdrawLevel>;
    DocumentSpecificData: DocumentSpecificData;
    'Option<DocumentSpecificData>': Option<DocumentSpecificData>;
    'Vec<DocumentSpecificData>': Vec<DocumentSpecificData>;
    KPDocumentDataOf: KPDocumentDataOf;
    'Option<KPDocumentDataOf>': Option<KPDocumentDataOf>;
    'Vec<KPDocumentDataOf>': Vec<KPDocumentDataOf>;
    KPModelDataOf: KPModelDataOf;
    'Option<KPModelDataOf>': Option<KPModelDataOf>;
    'Vec<KPModelDataOf>': Vec<KPModelDataOf>;
    KPCommentDataOf: KPCommentDataOf;
    'Option<KPCommentDataOf>': Option<KPCommentDataOf>;
    'Vec<KPCommentDataOf>': Vec<KPCommentDataOf>;
    DocumentPower: DocumentPower;
    'Option<DocumentPower>': Option<DocumentPower>;
    'Vec<DocumentPower>': Vec<DocumentPower>;
    QueryCommodityPowerParams: QueryCommodityPowerParams;
    'Option<QueryCommodityPowerParams>': Option<QueryCommodityPowerParams>;
    'Vec<QueryCommodityPowerParams>': Vec<QueryCommodityPowerParams>;
    QueryPlatformExpertParams: QueryPlatformExpertParams;
    'Option<QueryPlatformExpertParams>': Option<QueryPlatformExpertParams>;
    'Vec<QueryPlatformExpertParams>': Vec<QueryPlatformExpertParams>;
    QueryModelExpertParams: QueryModelExpertParams;
    'Option<QueryModelExpertParams>': Option<QueryModelExpertParams>;
    'Vec<QueryModelExpertParams>': Vec<QueryModelExpertParams>;
    CommodityTypeData: CommodityTypeData;
    'Option<CommodityTypeData>': Option<CommodityTypeData>;
    'Vec<CommodityTypeData>': Vec<CommodityTypeData>;
    QueryLeaderBoardParams: QueryLeaderBoardParams;
    'Option<QueryLeaderBoardParams>': Option<QueryLeaderBoardParams>;
    'Vec<QueryLeaderBoardParams>': Vec<QueryLeaderBoardParams>;
    LeaderBoardResult: LeaderBoardResult;
    'Option<LeaderBoardResult>': Option<LeaderBoardResult>;
    'Vec<LeaderBoardResult>': Vec<LeaderBoardResult>;
    CommodityLeaderBoardData: CommodityLeaderBoardData;
    'Option<CommodityLeaderBoardData>': Option<CommodityLeaderBoardData>;
    'Vec<CommodityLeaderBoardData>': Vec<CommodityLeaderBoardData>;
    StakeToVoteParams: StakeToVoteParams;
    'Option<StakeToVoteParams>': Option<StakeToVoteParams>;
    'Vec<StakeToVoteParams>': Vec<StakeToVoteParams>;
    StakeToVoteResult: StakeToVoteResult;
    'Option<StakeToVoteResult>': Option<StakeToVoteResult>;
    'Vec<StakeToVoteResult>': Vec<StakeToVoteResult>;
    ...
    AppFinanceExchangeDataParams: AppFinanceExchangeDataParams;
    'Option<AppFinanceExchangeDataParams>': Option<AppFinanceExchangeDataParams>;
    'Vec<AppFinanceExchangeDataParams>': Vec<AppFinanceExchangeDataParams>;
    AppFinanceExchangeDataRPC: AppFinanceExchangeDataRPC;
    'Option<AppFinanceExchangeDataRPC>': Option<AppFinanceExchangeDataRPC>;
    'Vec<AppFinanceExchangeDataRPC>': Vec<AppFinanceExchangeDataRPC>;
    AppFinancedUserExchangeConfirmParams: AppFinancedUserExchangeConfirmParams;
    'Option<AppFinancedUserExchangeConfirmParams>': Option<AppFinancedUserExchangeConfirmParams>;
    'Vec<AppFinancedUserExchangeConfirmParams>': Vec<AppFinancedUserExchangeConfirmParams>;
    ...
    'Option<CommentData>': Option<CommentData>;
    'Vec<CommentData>': Vec<CommentData>;
    AddAppParams: AddAppParams;
    'Option<AddAppParams>': Option<AddAppParams>;
    'Vec<AddAppParams>': Vec<AddAppParams>;
    ClientParamsCreateModel: ClientParamsCreateModel;
    'Option<ClientParamsCreateModel>': Option<ClientParamsCreateModel>;
    'Vec<ClientParamsCreateModel>': Vec<ClientParamsCreateModel>;
    AuthParamsCreateModel: AuthParamsCreateModel;
    'Option<AuthParamsCreateModel>': Option<AuthParamsCreateModel>;
    'Vec<AuthParamsCreateModel>': Vec<AuthParamsCreateModel>;
    ClientParamsCreatePublishDoc: ClientParamsCreatePublishDoc;
    'Option<ClientParamsCreatePublishDoc>': Option<ClientParamsCreatePublishDoc>;
    'Vec<ClientParamsCreatePublishDoc>': Vec<ClientParamsCreatePublishDoc>;
    ClientParamsCreateIdentifyDoc: ClientParamsCreateIdentifyDoc;
    'Option<ClientParamsCreateIdentifyDoc>': Option<ClientParamsCreateIdentifyDoc>;
    'Vec<ClientParamsCreateIdentifyDoc>': Vec<ClientParamsCreateIdentifyDoc>;
    ClientParamsCreateTryDoc: ClientParamsCreateTryDoc;
    'Option<ClientParamsCreateTryDoc>': Option<ClientParamsCreateTryDoc>;
    'Vec<ClientParamsCreateTryDoc>': Vec<ClientParamsCreateTryDoc>;
    ClientParamsCreateChooseDoc: ClientParamsCreateChooseDoc;
    'Option<ClientParamsCreateChooseDoc>': Option<ClientParamsCreateChooseDoc>;
    'Vec<ClientParamsCreateChooseDoc>': Vec<ClientParamsCreateChooseDoc>;
    ClientParamsCreateModelDoc: ClientParamsCreateModelDoc;
    'Option<ClientParamsCreateModelDoc>': Option<ClientParamsCreateModelDoc>;
    'Vec<ClientParamsCreateModelDoc>': Vec<ClientParamsCreateModelDoc>;
    ModelExpertAddMemberParams: ModelExpertAddMemberParams;
    'Option<ModelExpertAddMemberParams>': Option<ModelExpertAddMemberParams>;
    'Vec<ModelExpertAddMemberParams>': Vec<ModelExpertAddMemberParams>;
    ModelExpertDelMemberParams: ModelExpertDelMemberParams;
    'Option<ModelExpertDelMemberParams>': Option<ModelExpertDelMemberParams>;
    'Vec<ModelExpertDelMemberParams>': Vec<ModelExpertDelMemberParams>;
    AppData: AppData;
    'Option<AppData>': Option<AppData>;
    'Vec<AppData>': Vec<AppData>;
    ModelIncome: ModelIncome;
    'Option<ModelIncome>': Option<ModelIncome>;
    'Vec<ModelIncome>': Vec<ModelIncome>;
    ModelIncomeCollectingParam: ModelIncomeCollectingParam;
    'Option<ModelIncomeCollectingParam>': Option<ModelIncomeCollectingParam>;
    'Vec<ModelIncomeCollectingParam>': Vec<ModelIncomeCollectingParam>;
    ModelIncomeCurrentStageRPC: ModelIncomeCurrentStageRPC;
    'Option<ModelIncomeCurrentStageRPC>': Option<ModelIncomeCurrentStageRPC>;
    'Vec<ModelIncomeCurrentStageRPC>': Vec<ModelIncomeCurrentStageRPC>;
    ModelCycleIncomeReward: ModelCycleIncomeReward;
    'Option<ModelCycleIncomeReward>': Option<ModelCycleIncomeReward>;
    'Vec<ModelCycleIncomeReward>': Vec<ModelCycleIncomeReward>;
    DocumentPowerInfo: DocumentPowerInfo;
    'Option<DocumentPowerInfo>': Option<DocumentPowerInfo>;
    'Vec<DocumentPowerInfo>': Vec<DocumentPowerInfo>;
    ...
    CommentWeightData: CommentWeightData;
    'Option<CommentWeightData>': Option<CommentWeightData>;
    'Vec<CommentWeightData>': Vec<CommentWeightData>;
    KPCommentAccountRecord: KPCommentAccountRecord;
    'Option<KPCommentAccountRecord>': Option<KPCommentAccountRecord>;
    'Vec<KPCommentAccountRecord>': Vec<KPCommentAccountRecord>;
    KPModelCreateDataMax: KPModelCreateDataMax;
    'Option<KPModelCreateDataMax>': Option<KPModelCreateDataMax>;
    'Vec<KPModelCreateDataMax>': Vec<KPModelCreateDataMax>;
    KPProductChooseDataMax: KPProductChooseDataMax;
    'Option<KPProductChooseDataMax>': Option<KPProductChooseDataMax>;
    'Vec<KPProductChooseDataMax>': Vec<KPProductChooseDataMax>;
    KPProductIdentifyRateMax: KPProductIdentifyRateMax;
    'Option<KPProductIdentifyRateMax>': Option<KPProductIdentifyRateMax>;
    'Vec<KPProductIdentifyRateMax>': Vec<KPProductIdentifyRateMax>;
    KPProductPublishRateMax: KPProductPublishRateMax;
    'Option<KPProductPublishRateMax>': Option<KPProductPublishRateMax>;
    'Vec<KPProductPublishRateMax>': Vec<KPProductPublishRateMax>;
    KPProductTryRateMax: KPProductTryRateMax;
    'Option<KPProductTryRateMax>': Option<KPProductTryRateMax>;
    'Vec<KPProductTryRateMax>': Vec<KPProductTryRateMax>;
    ...
    AppFinancedUserExchangeData: AppFinancedUserExchangeData;
    'Option<AppFinancedUserExchangeData>': Option<AppFinancedUserExchangeData>;
    'Vec<AppFinancedUserExchangeData>': Vec<AppFinancedUserExchangeData>;
    QueryDocumentPowerParams: QueryDocumentPowerParams;
    'Option<QueryDocumentPowerParams>': Option<QueryDocumentPowerParams>;
    'Vec<QueryDocumentPowerParams>': Vec<QueryDocumentPowerParams>;
    TechFundWithdrawData: TechFundWithdrawData;
    'Option<TechFundWithdrawData>': Option<TechFundWithdrawData>;
    'Vec<TechFundWithdrawData>': Vec<TechFundWithdrawData>;
    MiscDocumentPowerParams: MiscDocumentPowerParams;
    'Option<MiscDocumentPowerParams>': Option<MiscDocumentPowerParams>;
    'Vec<MiscDocumentPowerParams>': Vec<MiscDocumentPowerParams>;
    AppKeyManageParams: AppKeyManageParams;
    'Option<AppKeyManageParams>': Option<AppKeyManageParams>;
    'Vec<AppKeyManageParams>': Vec<AppKeyManageParams>;
    QueryModelParams: QueryModelParams;
    'Option<QueryModelParams>': Option<QueryModelParams>;
    'Vec<QueryModelParams>': Vec<QueryModelParams>;
    CommoditySlashRecord: CommoditySlashRecord;
    'Option<CommoditySlashRecord>': Option<CommoditySlashRecord>;
    'Vec<CommoditySlashRecord>': Vec<CommoditySlashRecord>;
    ModelDisputeRecord: ModelDisputeRecord;
    'Option<ModelDisputeRecord>': Option<ModelDisputeRecord>;
    'Vec<ModelDisputeRecord>': Vec<ModelDisputeRecord>;
    AppIncomeCycleRecord: AppIncomeCycleRecord;
    'Option<AppIncomeCycleRecord>': Option<AppIncomeCycleRecord>;
    'Vec<AppIncomeCycleRecord>': Vec<AppIncomeCycleRecord>;
    AppIncomeRecordParams: AppIncomeRecordParams;
    'Option<AppIncomeRecordParams>': Option<AppIncomeRecordParams>;
    'Vec<AppIncomeRecordParams>': Vec<AppIncomeRecordParams>;
    AppIncomeExchangeDataParams: AppIncomeExchangeDataParams;
    'Option<AppIncomeExchangeDataParams>': Option<AppIncomeExchangeDataParams>;
    'Vec<AppIncomeExchangeDataParams>': Vec<AppIncomeExchangeDataParams>;
    AppIncomeRedeemParams: AppIncomeRedeemParams;
    'Option<AppIncomeRedeemParams>': Option<AppIncomeRedeemParams>;
    'Vec<AppIncomeRedeemParams>': Vec<AppIncomeRedeemParams>;
    AppIncomeRedeemConfirmParams: AppIncomeRedeemConfirmParams;
    'Option<AppIncomeRedeemConfirmParams>': Option<AppIncomeRedeemConfirmParams>;
    'Vec<AppIncomeRedeemConfirmParams>': Vec<AppIncomeRedeemConfirmParams>;
    DisableModelParams: DisableModelParams;
    'Option<DisableModelParams>': Option<DisableModelParams>;
    'Vec<DisableModelParams>': Vec<DisableModelParams>;
    AppIncomeDataRPC: AppIncomeDataRPC;
    'Option<AppIncomeDataRPC>': Option<AppIncomeDataRPC>;
    'Vec<AppIncomeDataRPC>': Vec<AppIncomeDataRPC>;
    ModelKeyParams: ModelKeyParams;
    'Option<ModelKeyParams>': Option<ModelKeyParams>;
    'Vec<ModelKeyParams>': Vec<ModelKeyParams>;
    FinanceMemberParams: FinanceMemberParams;
    'Option<FinanceMemberParams>': Option<FinanceMemberParams>;
    'Vec<FinanceMemberParams>': Vec<FinanceMemberParams>;
  }
}
