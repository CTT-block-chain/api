...
import type { AccountID32, AppData, AppFinancedData, AuthAccountId, CommentMaxRecord, CommentTrend, CommentWeightData, CommodityLeaderBoardData, CommodityTypeData, DocumentPower, DocumentSpecificData, DocumentType, KPCommentAccountRecord, KPCommentDataOf, KPDocumentDataOf, KPModelCreateData, KPModelCreateDataMax, KPModelDataOf, KPProductChooseData, KPProductChooseDataMax, KPProductIdentifyData, KPProductIdentifyRateMax, KPProductPublishData, KPProductPublishRateMax, KPProductTryData, KPProductTryRateMax, LeaderBoardItem, LeaderBoardItemRPC, LeaderBoardResult, LeaderBoardResultRPC, ModelDisputeType, ModelStatus, PowerSize, QueryCommodityPowerParams, QueryLeaderBoardParams, QueryModelExpertParams, QueryPlatformExpertParams, StableExchangeData, StakeToVoteParams, StakeToVoteResult } from '@polkadot/types/interfaces/kp';
