...
import type { AccountID32, AuthAccountId, CommentTrend, CommodityLeaderBoardData, CommodityTypeData, DocumentPower, DocumentSpecificData, DocumentType, KPCommentDataOf, KPDocumentDataOf, KPModelCreateData, KPModelDataOf, KPProductChooseData, KPProductIdentifyData, KPProductPublishData, KPProductTryData, LeaderBoardItem, LeaderBoardItemRPC, LeaderBoardResult, LeaderBoardResultRPC, ModelDisputeType, ModelStatus, PowerSize, QueryCommodityPowerParams, QueryLeaderBoardParams, QueryModelExpertParams, QueryPlatformExpertParams } from '@polkadot/types/interfaces/kp';
